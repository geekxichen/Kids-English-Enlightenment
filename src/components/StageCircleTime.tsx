      ...
      <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] gap-6">
        <div className="bg-white rounded-3xl p-6 shadow-md border-4 border-white">
          ...
          <div className="space-y-2">
            <div draggable onDragStart={e => { e.dataTransfer.setData('text', 'MORNING'); e.dataTransfer.setData('type', 'time'); e.dataTransfer.setData('color', '#535c68'); }} onClick={() => speakWord('Morning')} className="bg-[#f6e58d] text-[#535c68] p-3 rounded-xl text-center font-bold cursor-grab shadow-sm">MORNING</div>
            <div draggable onDragStart={e => { e.dataTransfer.setData('text', 'AFTERNOON'); e.dataTransfer.setData('type', 'time'); e.dataTransfer.setData('color', 'white'); }} onClick={() => speakWord('Afternoon')} className="bg-[#ffbe76] text-white p-3 rounded-xl text-center font-bold cursor-grab shadow-sm">AFTERNOON</div>
            <div draggable onDragStart={e => { e.dataTransfer.setData('text', 'EVENING'); e.dataTransfer.setData('type', 'time'); e.dataTransfer.setData('color', 'white'); }} onClick={() => speakWord('Evening')} className="bg-[#30336b] text-white p-3 rounded-xl text-center font-bold cursor-grab shadow-sm">EVENING</div>
          </div>
          ...
          <div className="space-y-2">
            <div draggable onDragStart={e => { e.dataTransfer.setData('text', 'MONDAY'); e.dataTransfer.setData('type', 'day'); e.dataTransfer.setData('color', 'white'); }} onClick={() => speakWord('Monday')} className="bg-[#ff9f43] text-white p-3 rounded-xl text-center font-bold cursor-grab shadow-sm">MONDAY</div>
            <div draggable onDragStart={e => { e.dataTransfer.setData('text', 'TUESDAY'); e.dataTransfer.setData('type', 'day'); e.dataTransfer.setData('color', 'white'); }} onClick={() => speakWord('Tuesday')} className="bg-[#feca57] text-white p-3 rounded-xl text-center font-bold cursor-grab shadow-sm">TUESDAY</div>
            <div draggable onDragStart={e => { e.dataTransfer.setData('text', 'WEDNESDAY'); e.dataTransfer.setData('type', 'day'); e.dataTransfer.setData('color', 'white'); }} onClick={() => speakWord('Wednesday')} className="bg-[#1dd1a1] text-white p-3 rounded-xl text-center font-bold cursor-grab shadow-sm">WEDNESDAY</div>
            <div draggable onDragStart={e => { e.dataTransfer.setData('text', 'THURSDAY'); e.dataTransfer.setData('type', 'day'); e.dataTransfer.setData('color', 'white'); }} onClick={() => speakWord('Thursday')} className="bg-[#48dbfb] text-white p-3 rounded-xl text-center font-bold cursor-grab shadow-sm">THURSDAY</div>
            <div draggable onDragStart={e => { e.dataTransfer.setData('text', 'FRIDAY'); e.dataTransfer.setData('type', 'day'); e.dataTransfer.setData('color', 'white'); }} onClick={() => speakWord('Friday')} className="bg-[#5f27cd] text-white p-3 rounded-xl text-center font-bold cursor-grab shadow-sm">FRIDAY</div>
            <div draggable onDragStart={e => { e.dataTransfer.setData('text', 'SATURDAY'); e.dataTransfer.setData('type', 'day'); e.dataTransfer.setData('color', 'white'); }} onClick={() => speakWord('Saturday')} className="bg-[#ff9ff3] text-white p-3 rounded-xl text-center font-bold cursor-grab shadow-sm">SATURDAY</div>
            <div draggable onDragStart={e => { e.dataTransfer.setData('text', 'SUNDAY'); e.dataTransfer.setData('type', 'day'); e.dataTransfer.setData('color', 'white'); }} onClick={() => speakWord('Sunday')} className="bg-[#ff6b6b] text-white p-3 rounded-xl text-center font-bold cursor-grab shadow-sm">SUNDAY</div>
          </div>
        </div>
